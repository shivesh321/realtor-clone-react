      ...
      px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          ...
          <input  
            ...
            text-gray-70 bg-white border-gray-300 rounded
           ...
           top-3 text-xl cursor-pointer'  onClick={()=>setShowPassword((prevState)=>
            !prevState)}
            />
            )  : (<AiFillEye  className='absolute right-3 top-3
           text-xl cursor-pointer' onClick={()=>setShowPassword((prevState)=>
            !prevState)}/>)}
           ...
           <div className='flex justify-between whitespace-nowrap text-sm sm-text-lg'>
            ...
            hover:text-red-700 transition duration-200 ease-in-out ml-1'>Sign in</Link>  
            </p>
            <p>
              <Link to="/forgot-password" className='text-blue-600
            hover:text-blue-800 transition duration-200 ease-in-out ml-2'>Forgot password?</Link>
            </p>
           </div>
          ...
          transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type="submit">Sign up</button>
