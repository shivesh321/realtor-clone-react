...
export default function ForgotPassword() {
  ...
  async function onSubmit(e){
    e.preventDefault("Could not send reset password")
    try {
      const auth = getAuth()
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
           ...
           <div className='flex justify-between whitespace-nowrap text-sm sm-text-lg'>
            ...
            hover:text-blue-800 transition duration-200 ease-in-out ml-2'>Sign in instead</Link>
            </p>
           </div>
          ...
          transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type="submit">Send reset password</button>
