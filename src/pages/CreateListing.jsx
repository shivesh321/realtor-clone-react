...
export default function CreateListing() {
    ...
    const { type, name, bedrooms, bathrooms, parking, furnished, discountedPrice, offer, description, address, regularPrice } = formData;
    function onChange(){

    }
  return (
    <main className='max-w-mid px-2 mx-auto'>
        ...
        <form>
            ...
            <div className='flex'>
                ...
                uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg
            ...
            {onChange} placeholder='Name' maxLength="32" minLength="10" required className='w-full px-4 py-2 text-xl text-gray-700
            bg-white border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white
            ...
            <div className="flex space-x-6 mb-6 ">
                <div>
                    ...
                    border-gray-300 rounded duration ease-in-out focus:text-gray-700
            ...
            <div className="flex items-center mb-6">
                <div className="">
                    ...
                    space-x-6">
                        ...
                        border-gray-300 rounded transition duration-100
